...
import { ChevronRight, Plus, DollarSign, CheckCircle2, Sparkles, Zap, Wrench, Home, FileText, Users, Building, BarChart3, Phone, Mail, MapPin, Search, Filter, Clock, TrendingUp, Activity, Eye, Edit, Trash2, Download, Settings, User, Bell, Menu, X } from 'lucide-react';
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="text" defaultValue="ProPlumbing Inc." className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl outline-none focus:border-green-500" />
            </div>
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">License Number</label>
              <input type="text" defaultValue="PL-12345-CA" className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl outline-none focus:border-green-500" />
            </div>
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">Phone</label>
              <input type="tel" defaultValue="(555) 987-6543" className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl outline-none focus:border-green-500" />
            </div>
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">Email</label>
              <input type="email" defaultValue="info@proplumbing.com" className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl outline-none focus:border-green-500" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="text" defaultValue="123 Business Ave" className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl outline-none focus:border-green-500" />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">City</label>
                <input type="text" defaultValue="Los Angeles" className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl outline-none focus:border-green-500" />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">State</label>
                <input type="text" defaultValue="CA" className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl outline-none focus:border-green-500" />
              </div>
            </div>
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">ZIP Code</label>
              <input type="text" defaultValue="90001" className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl outline-none focus:border-green-500" />
            </div>
          </div>
        </div>
      </div>
